...
class TestViews(TestCase):
    ...
    def test_cancel_booking_redirects(self):
        ...
        Then asserts the redirect URL is the login page, the correct
        redirect location as no user is signed in.

        Signs into the second user, 'Jane Doe' created in the setUp method.
        Uses Django's in-built HTTP client, to get /cancel/1 in the URL.
        Asserts equal to status code 302, a redirect response.
